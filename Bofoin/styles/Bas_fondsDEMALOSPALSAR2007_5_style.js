...
var style_Bas_fondsDEMALOSPALSAR2007_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("volume");
    var labelText = "";
    size = 0;
    ...
    if (value >= 22894.020370 && value <= 2211843.951880) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2211843.951880 && value <= 7870314.300800) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7870314.300800 && value <= 18970782.412000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18970782.412000 && value <= 39005414.699800) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 39005414.699800 && value <= 58483189.022100) {
            style = [ new ol.style.Style({
